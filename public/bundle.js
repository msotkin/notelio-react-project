...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function (_Component) {
	  ...
	  function App() {
	    ...
	    _this.makeCard = _this.makeCard.bind(_this);
	    _this.cloneState = _this.cloneState.bind(_this);
	  ...
	  _createClass(App, [{
	    key: 'onMove',
	    value: function onMove(e, id) {
	      var clone = this.cloneState();
	      var coordsObj = { id: id, x: clone.cards[id].x + e.dx, y: clone.cards[id].y + e.dy };
	    ...
	    value: function render() {
	      ...
	      this.state.cards.forEach(function (card) {
	        cardArr.push(_react2.default.createElement(_Notecard2.default, { key: card.id, id: card.id, coords: card, onMove: function onMove(e) {
	            _this2.onMove(e, card.id);
	          } }));
	      });
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_Navbar2.default, { makeCard: this.makeCard, deleteCard: this.deleteCard }),
	        cardArr
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _interact = __webpack_require__(160);
	...
	var Notecard = function (_Component) {
	    ...
	    function Notecard() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Notecard).apply(this, arguments));
	    }

	    _createClass(Notecard, [{
	        key: 'componentDidMount',
	        value: function componentDidMount() {
	            var gridTarget = _interact2.default.createSnapGrid({
	                x: 0,
	                y: 300,
	                range: 50
	            });
	            (0, _interact2.default)(_reactDom2.default.findDOMNode(this)).draggable({
	        ...
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement('textarea', { className: 'notecard', maxLength: '200', style: this.style() });
	        }
	    }, {
	        key: 'style',
